...
def weather(update, context):
    ...
    try:
        location = str(context.args[0])
        update.message.reply_text(get_weather(location))
    except:
...
def score(update, context):
    ...
    try:
        ...
        location = str(context.args[0])
        update.message.reply_text("loading... Sentiment Score... ")
        update.message.reply_text(search_score(location))
...
def reviews(update, context):
    ...
    try:
        ...
        update.message.reply_text(search_reviews(location))
...
def help(update, context):
    ...
    /weather 'location': generate weather forecast for given location
    /score 'location': generates an overall sentiment score for the given location
    /reviews 'location': generates most frequent sentiments for the given location
